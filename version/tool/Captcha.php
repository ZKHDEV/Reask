<?php
	class Imagecode{
		...
		private $fonturl;
		private $session;
		function __construct($width = 100,$height = 34,$counts = 4,$distrubcode="1235467890qwertyuipkjhgfdaszxcvbnm",$fonturl="../assets/fonts/msyh.ttc"){
			$this->width=$width;
			$this->height=$height;
			$this->counts=$counts;
		...
		private function set_code($im){
				...
				$fontsize=rand(30,35);
				$fonturl="../assets/fonts/msyhbd.ttc";
